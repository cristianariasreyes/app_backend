...
class Chat_session(models.Model):
    ...
    id_user = models.ForeignKey(User,related_name='chat_sessions', on_delete=models.PROTECT)
...
class Chat_history(models.Model):
    ...
    id_user = models.ForeignKey(User,related_name='chat_historys', on_delete=models.PROTECT)
...
class Chat_assistant(models.Model):
    ...
    created_by = models.ForeignKey(User,default=1, related_name='chat_assistants',on_delete=models.PROTECT)
...
class Chat_assistant_documents(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='chat_assistant_documents',on_delete=models.PROTECT)
