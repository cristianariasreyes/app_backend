...
urlpatterns = [
    ...
    path(
        "chat_assistant/<int:id>",
        views.Getchat_assistant_detail,
        name="Getchat_assistant_detail",
    ),
    path(
        "chat_assistant_documents/",
        views.Get_chat_assistant_document,
        name="Get_chat_assistant_document",
    ),
    path(
        "chat_assistant_documents/<int:id>",
    ...
    path(
        ...
        name="chat_with_an_assistant",
    ),
    path(
        "chat/evaluate_answer/<int:id_chat_history>/<int:useful>",
